...
function(sanity_require_protobuf given_version)
    ...
    set(Protobuf_PROTOC_LIBRARY "${sanity.target.local}/lib/libprotoc.a" CACHE PATH "set by sanity" FORCE)
    ...
    set(_PROTOBUF_PROTOC_EXECUTABLE_VERSION "${Protobuf_VERSION}" CACHE STRING "set by sanity" FORCE)
    set(Protobuf_LIBRARIES "${sanity.target.local}/lib/libprotobuf.a" CACHE PATH "set by sanity" FORCE)
    set(Protobuf_PROTOC_LIBRARIES "${sanity.target.local}/lib/libprotobuf.a" CACHE PATH "set by sanity" FORCE)
    set(Protobuf_LITE_LIBRARIES "${sanity.target.local}/lib/libprotobuf-lite.a" CACHE PATH "set by sanity" FORCE)
    set(Protobuf_LIBRARY "${sanity.target.local}/lib/libprotobuf.a" CACHE PATH "set by sanity" FORCE)
    ...
    sanity_propagate_vars(sanity.require_protobuf.complete)
