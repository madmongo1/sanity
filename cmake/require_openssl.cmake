...
error code : ${res}"
    ...
    #simulate outputs of FindOpenSSL
        set(OPENSSL_FOUND TRUE CACHE BOOL "set by sanity" FORCE)
    set(OPENSSL_INCLUDE_DIR "${sanity.target.local}/ssl/include" CACHE PATH "set by sanity" FORCE)
    set(OPENSSL_CRYPTO_LIBRARY "${sanity.target.local}/ssl/lib/libcrypto.a" CACHE PATH "set by sanity" FORCE)
    set(OPENSSL_SSL_LIBRARY "${sanity.target.local}/ssl/lib/libssl.a" CACHE PATH "set by sanity" FORCE)
    set(OPENSSL_LIBRARIES ${OPENSSL_SSL_LIBRARY} ${OPENSSL_CRYPTO_LIBRARY} ${CMAKE_THREAD_LIBS_INIT} ${CMAKE_DL_LIBS} CACHE STRING "set by sanity" FORCE)
    set(OPENSSL_VERSION "${version}" CACHE STRING "set by sanity" FORCE)

    #set inputs for FindOpenSSL
    sanity_propagate_value(NAME OPENSSL_ROOT_DIR VALUE "${sanity.target.local}/ssl")
