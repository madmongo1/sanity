...
function(boost_bootstrap)
    ...
    if ("${CMAKE_CURRENT_LIST_FILE}" IS_NEWER_THAN "${bootstrap_needed}")
        set(need_bootstrap TRUE)
        sanity_touch_flag(bootstrap_needed)
        message(STATUS "bootstrap needed CMakeLists file has been updated")
    endif ()
...
function(boost_append_real_libs inoutvar)
    ...
    if ("${ARG_COMPONENT}" STREQUAL "regex")
        sanity_require(LIBRARY icu VERSION any)
#        message(STATUS "adding icu libraries ${ICU_LIBRARIES}")
        list(APPEND result "${ICU_LIBRARIES}")
    endif ()
...
#        message(STATUS "*****")
#        message(STATUS "component: ${ARG_COMPONENT} libs: ${real_libs}")
